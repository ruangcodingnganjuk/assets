...
openai.api_key = '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'

# Set the Telegram bot token
bot_token = '5887781535:AAFrR9TZ4UA0JjLuzCALwyznEyOFlq5U_B0'
...
def start(update, context):
    context.bot.send_message(chat_id=update.effective_chat.id, text="Hello! saya RCN_Bot..... adakah yang bisa saya bantu? silakan tinggalkan pesan :)")
